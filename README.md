...
| `disable_userinfo_header` | no | false | Disable passing the Userinfo to the upstream server |
| `disable_id_token_header` | no | false | Disable passing the ID Token to the upstream server |
| `disable_access_token_header` | no | false | Disable passing the Access Token to the upstream server |
